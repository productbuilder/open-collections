...
class PbWorkspaceLayoutElement extends HTMLElement {
  ...
  syncState() {
    ...
    shell.dataset.mobileTreeOpen = this.getAttribute('mobile-tree-open') === 'true' ? 'true' : 'false';
    shell.dataset.mobileDetailsOpen = this.getAttribute('mobile-details-open') === 'true' ? 'true' : 'false';
  }
