...
class OpenCollectionsAddConnectionPanelElement extends HTMLElement {
  ...
  bindEvents() {
    this.shadowRoot.getElementById('backToConnectionsBtn')?.addEventListener('click', () => {
    ...
    this.shadowRoot.getElementById('addExampleConnectionBtn')?.addEventListener('click', () => {
...
if (!customElements.get('open-collections-add-connection-panel')) {
  customElements.define('open-collections-add-connection-panel', OpenCollectionsAddConnectionPanelElement);
}
