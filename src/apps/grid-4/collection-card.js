...
class Grid4CollectionCardElement extends HTMLElement {
  constructor() {
    super();
...
if (!customElements.get("grid4-card-collection")) {
  customElements.define("grid4-card-collection", Grid4CollectionCardElement);
}

export { Grid4CollectionCardElement };
