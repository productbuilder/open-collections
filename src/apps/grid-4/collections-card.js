...
class Grid4CollectionsCardElement extends HTMLElement {
  constructor() {
    super();
      ...
      <article class="card card--source" tabindex="0" role="button" aria-label="${actionLabel} ${title}">
        <div class="card__header card__header--source">
          <div class="sourceHeader">
            ...
            <div class="sourceHeader__content">
...
if (!customElements.get("grid4-card-collections")) {
  customElements.define("grid4-card-collections", Grid4CollectionsCardElement);
}

export { Grid4CollectionsCardElement };
