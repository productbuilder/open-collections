...
class Open_Collections_Output {
	...
	/**
	 * Legacy compatibility routes from the earlier integration variant.
	 */
	public function register_rest_routes() {
		register_rest_route(
			...
			array(
				...
				'callback' => array($this, 'render_collection_rest_stub'),
		...
		register_rest_route(
			...
			array(
				'methods' => WP_REST_Server::READABLE,
				'callback' => array($this, 'render_item_rest_stub'),
				'permission_callback' => '__return_true',
			)
		);
		...
		register_rest_route(
			...
			array(
				'methods' => WP_REST_Server::READABLE,
				'callback' => array($this, 'render_media_rest_stub'),
				'permission_callback' => '__return_true',
			)
		);
	}
	...
	public function render_collection_rest_stub() {
		$settings = $this->settings->get_settings();
	...
	public function render_item_rest_stub($request) {
		return rest_ensure_response(
			array(
	...
	public function render_media_rest_stub($request) {
		return rest_ensure_response(
			array(
